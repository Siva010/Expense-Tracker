...
const Navbar = ({ activeMenu, children }) => {
  ...
  return (
    <div className={`relative flex items-center justify-center border border-b sticky top-0 z-30 backdrop-blur-[2px] py-4 px-7 ${
      isDark ? "bg-gray-900 border-gray-700" : "bg-white border-gray-400"
    }`}>
      <button
